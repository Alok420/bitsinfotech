                            ...
                            <div class="row">
                                <div class="form-group col-md-6 offset-3">
                                    ...
                                    <select name="quiz-id" class="form-control" onchange="this.form.submit();">
                                        ...
                                        @foreach ($quiz as $q)
                                            <option @if (@$quiz_id == $q->id) selected @endif
                                ...
                                @foreach ($question as $ques)
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label for="Name">Q.{{ $i }} {{ $ques->question }}
                                                ?</label><br><br>
                                            ...
                                            <ol>
                                                <li>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <input hidden type="number" name="question-id[]"
                                                                value={{ $ques->id }}>
                                                            <input type="text"
                                                                value="{{ @$ques->getAnswer[$for_get_answer_key]->answer }}"
                                                                name="answer-{{ $ques->id }}[]" class="form-control"
                                                                required>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <input @if (@$ques->getAnswer[$for_get_answer_key]->is_right == 1) checked @endif
                                                                type="radio" value="0"
                                                                name="right-answer-{{ $ques->id }}" class="radio"
                                                                required>
                                                        </div>
                                                    </div>
                                                </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <input type="text"
                                                                value="{{ @$ques->getAnswer[$for_get_answer_key]->answer }}"
                                                                name="answer-{{ $ques->id }}[]"
                                                                @if (@$question_single) value="{{ $question_single->name }}" @endif
