            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h2 align="center">Add Courses</h2>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-5 offset-1">
                                    ...
                                    <input type="text" name="name"
                                        @if (@$course_single) value="{{ $course_single->name }}" @endif
                                        class="form-control">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="number" name="fees"
                                        @if (@$course_single) value="{{ $course_single->fees }}" @endif
                                        class="form-control">
                                    <span class="text-danger">
                                        @error('email')
                                            {{ $message }}
                            ...
                            <div class="row">
                                <div class="form-group col-md-5 offset-1">
                                    ...
                                    <input type="number" name="duration"
                                        @if (@$course_single) value="{{ $course_single->duration }}" @endif
                                        class="form-control">
                                ...
                                <div class="form-group col-md-5">
                                    ...
                                    <input type="file" name="course-image"
                                        @if (@$course_single) value="{{ $course_single->fees }}" @endif
                                        class="form-control">
                                    <span class="text-danger">
                                        @error('course-image')
                            ...
                            <tbody>
                                ...
                                @foreach ($course as $c)
                                    <tr>
                                        ...
                                        @endphp
                                        <td> <img width="100" height="50" src="{{ $image_path }}" alt="loading...">
                                        </td>
                                        <td>
                                            <a href="{{ route('delete-course', ['id' => $c->id]) }}"
                                                class="btn btn-danger">Delete</a>



                                            &nbsp;<a href="{{route('edit-course',['id'=>$c->id])}}" class="btn btn-primary">Update</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
